...
const ContributeSuperAnnuationSchema = (ContributeSuperAnnuation) => {
  ...
  return schema.validate(ContributeSuperAnnuation);
};

module.exports = ContributeSuperAnnuationSchema;
