...
const ReviewInvestmentPortfolioSchema = (ReviewInvestmentPortfolio) => {
  ...
  return schema.validate(ReviewInvestmentPortfolio);
};

module.exports = ReviewInvestmentPortfolioSchema;
