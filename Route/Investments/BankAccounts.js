...
const ClientDetails = require("../../Models/Investments/BankAccounts");
const ClientAssetSchema = require("../../Schema/Investments/BankAccounts");
...
MyRouter.patch('/Update/:Email/:_id', async(req, res) => {
    ...
    UpdateClientInvestment.BankCurrentValue = req.body.BankCurrentValue,
    UpdateClientInvestment.BankFinancialInstitution = req.body.BankFinancialInstitution,
    UpdateClientInvestment.BankIncomePA = req.body.BankIncomePA,
    UpdateClientInvestment.BankIncomePAType = req.body.BankIncomePAType,
    UpdateClientInvestment.BankIncomeinDollars = req.body.BankIncomeinDollars,
    UpdateClientInvestment.BankRegularSavings = req.body.BankRegularSavings,
    UpdateClientInvestment.BankReinvestedIncome = req.body.BankReinvestedIncome
