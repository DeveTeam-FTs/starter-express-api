...
const SuperBeneficiaryDetails = require('../../../Models/Retirements/Partner/Super_Investment');
const SuperBeneficiarySchema = require('../../../Schema/Retirements/Partner/Super_Investment');
...
MyRouter.post('/Add-Partner-Super-Investment', async(req, res) => {
...
MyRouter.patch('/Update-Partner-Super-Investment/:Email/:_id', async(req, res) => {
...
MyRouter.delete('/Delete-Partner-Super-Investment/:Email/:_id', async(req, res) => {
