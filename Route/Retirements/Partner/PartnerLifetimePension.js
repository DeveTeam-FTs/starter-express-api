...
const RetirementPartnerDetails = require("../../../Models/Retirements/Partner/Partner_LifetimePension");
const PartnerSchema = require("../../../Schema/Retirements/Partner/PartnerLifetimePension");
...
MyRouter.post("/Add-Partner-LifetimePension", async (req, res) => {
...
MyRouter.patch(
  "/Update-Partner-LifetimePension/:Email/:_id",
  async (req, res) => {
    ...
    (UpdatePartnerRetirement.Email = req.body.Email),
      (UpdatePartnerRetirement.LifePension_FundName =
        req.body.LifePension_FundName),
      (UpdatePartnerRetirement.LifePension_RegularIncome =
        req.body.LifePension_RegularIncome),
      (UpdatePartnerRetirement.LifePension_Frequency =
        req.body.LifePension_Frequency),
      (UpdatePartnerRetirement.LifePension_DeductibleAmount =
        req.body.LifePension_DeductibleAmount),
      (UpdatePartnerRetirement.LifePension_TaxFree_Pension =
        req.body.LifePension_TaxFree_Pension),
      (UpdatePartnerRetirement.LifePension_TaxablePensionAmount =
...
MyRouter.delete(
  "/Delete-Partner-LifetimePension/:Email/:_id",
  async (req, res) => {
