...
const RetirementClientDetails = require('../../../Models/Retirements/Client/Client_SuperAccounts');
const ClientSchema = require('../../../Schema/Retirements/Client/ClientSuperAccounts');
...
MyRouter.patch('/Update-Client-RetirementSuperAccount/:Email/:_id', async(req, res) => {
...
MyRouter.delete('/Delete-Client-RetirementSuperAccount/:Email/:_id', async(req, res) => {
