...
const SuperBeneficiariesDetails = require('../../../Models/Retirements/Client/Super_Beneficiaries');
const SuperBeneficiariesSchema = require('../../../Schema/Retirements/Client/Super_Beneficiaries');
...
MyRouter.post('/Add-Client-Super-Beneficiaries', async(req, res) => {
...
MyRouter.patch('/Update-Client-Super-Beneficiaries/:Email/:_id', async(req, res) => {
...
MyRouter.delete('/Delete-Client-Super-Beneficiaries/:Email/:_id', async(req, res) => {
