...
const ClientDetails = require("../../../Models/Business/Client/SoleTrader");
const ClientSchema = require("../../../Schema/Business/Client/SoleTrader");
...
MyRouter.post('/Add-Client-SoleTrader', async(req, res) => {
...
MyRouter.patch("/Update-Client-SoleTrader/:Email", async(req, res) => {
    ...
    //******************************** End of Client Sole Trader - Business Details ********************************
...
MyRouter.delete("/Delete-Client-SoleTrader/:Email", async(req, res) => {
