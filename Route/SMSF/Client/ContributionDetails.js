...
const Client_ContributionDetails = require("../../../Models/SMSF/Client/ContributionDetails");
const ContributionSchema = require("../../../Schema/SMSF/Client/ContributionDetails");
...
MyRouter.post("/Add-Client-Contribution", async(req, res) => {
...
MyRouter.patch("/Update-Client-Contribution/:Email/:_id", async(req, res) => {
    const UpdateClient = await Client_ContributionDetails.findOne({ Email: req.params.Email, _id: req.params._id });
...
MyRouter.delete("/Delete-Client-Contribution/:Email/:_id", async(req, res) => {
    const DeleteClient = await Client_ContributionDetails.findOne({ Email: req.params.Email, _id: req.params._id });
    try{
