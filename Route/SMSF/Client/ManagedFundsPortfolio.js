...
const ClientDetails = require("../../../Models/SMSF/Client/ManagedFundsPortfolio");
const ClientAssetSchema = require("../../../Schema/SMSF/Client/ManagedFundsPortfolio");
...
MyRouter.patch('/Update-Client-ManagedFunds-Portfolio/:Email/:_id', async(req, res) => {
    ...
    UpdateClientInvestment.ManagedFundsPortfolioRepaymentAmount = req.body.ManagedFundsPortfolioRepaymentAmount,
