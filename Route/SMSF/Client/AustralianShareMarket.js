...
MyRouter.patch("/Update-Client-AustralianShareMarket/:Email/:_id", async(req, res) => {
    const UpdateClient = await Client_AustralianShareMarketDetails.findOne({ Email: req.params.Email, _id: req.params._id });
...
MyRouter.delete("/Delete-Client-AustralianShareMarket/:Email/:_id", async(req, res) => {
    const DeleteClient = await Client_AustralianShareMarketDetails.findOne({ Email: req.params.Email, _id: req.params._id });
    try{
