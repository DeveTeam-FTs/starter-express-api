...
MyRouter.patch("/Update-Client-InvestmentProperties/:Email/:_id", async(req, res) => {
    const UpdateClient = await Client_InvestmentPropertiesDetails.findOne({ Email: req.params.Email, _id: req.params._id });
...
MyRouter.delete("/Delete-Client-InvestmentProperties/:Email/:_id", async(req, res) => {
    const DeleteClient = await Client_InvestmentPropertiesDetails.findOne({ Email: req.params.Email, _id: req.params._id });
    try{
