...
const ClientDetails = require("../../../Models/SMSF/Client/AustralianSharePortfolio");
const ClientAssetSchema = require("../../../Schema/SMSF/Client/AustralianSharePortfolio");
...
MyRouter.patch('/Update-Client-Australian-Market-Portfolio/:Email/:_id', async(req, res) => {
    ...
    UpdateClientInvestment.AustralianPortfolioRepaymentAmount = req.body.AustralianPortfolioRepaymentAmount,
    UpdateClientInvestment.AustralianPortfolioFrequency = req.body.AustralianPortfolioFrequency,
    UpdateClientInvestment.AustralianPortfolioAnnualRepayment = req.body.AustralianPortfolioAnnualRepayment,
...
MyRouter.delete('/Delete-Client-Australian-Market-Portfolio/:Email/:_id', async(req, res) => {
