...
MyRouter.patch("/Update-Client-Accumulation/:Email/:_id", async(req, res) => {
    const UpdateClient = await Client_AccumulationDetails.findOne({ Email: req.params.Email, _id: req.params._id });
...
MyRouter.delete("/Delete-Client-Accumulation/:Email/:_id", async(req, res) => {
    const DeleteClient = await Client_AccumulationDetails.findOne({ Email: req.params.Email, _id: req.params._id });
    try{
