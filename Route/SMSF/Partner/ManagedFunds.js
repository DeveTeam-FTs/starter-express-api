...
MyRouter.patch("/Update-Client-ManagedFunds/:Email", async(req, res) => {
    const UpdateClient = await Client_ManagedFundsDetails.findOne({ Email: req.params.Email});
...
MyRouter.delete("/Delete-Client-ManagedFunds/:Email", async(req, res) => {
    const DeleteClient = await Client_ManagedFundsDetails.findOne({ Email: req.params.Email});
    try{
